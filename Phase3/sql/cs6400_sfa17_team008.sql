...
CREATE TABLE Customer (
 ...
 CREATE TABLE Clerk (
	username varchar(80) NOT NULL,
 	clerk_id int(16) unsigned,
 	date_of_hire date NOT NULL,
 	PRIMARY KEY (username)
 );
 
CREATE TABLE Phone (
	phone_type varchar(80),
...
CREATE TABLE Pliers (
	tool_id int(16) unsigned NOT NULL,
    adjustable varchar(5),
    PRIMARY KEY (tool_id)
);
CREATE TABLE Gun (
	tool_id int(16) unsigned NOT NULL,
	gauge_rating varchar(80),
	capacity varchar(80) NOT NULL,
	PRIMARY KEY (tool_id)
);
CREATE TABLE Hammer (
	tool_id int(16) unsigned NOT NULL,
	anti_vibration varchar(5),
	PRIMARY KEY (tool_id)
);
...
CREATE TABLE Ladders (
	tool_id int(16) unsigned NOT NULL,
	step_count int(16),
	weight_capacity varchar(80),
	PRIMARY KEY (tool_id)
);
CREATE TABLE Straight (
    tool_id int(16) unsigned NOT NULL,
    rubber_feet varchar(5),
    PRIMARY KEY (tool_id)
);
CREATE TABLE Step (
	tool_id int(16) unsigned NOT NULL,
	pail_shelf varchar(5),
	PRIMARY KEY (tool_id)
);
...
ALTER TABLE Phone
	ADD CONSTRAINT FK_Phone_username_User_username
	FOREIGN KEY (username) REFERENCES `User` (username);
ALTER TABLE `Order`
	ADD CONSTRAINT FK_Order_reservation_id_Reservation_reservation_id
	FOREIGN KEY  (reservation_id) REFERENCES Reservation (reservation_id),
	ADD CONSTRAINT FK_Order_tool_id_Tools_tool_id
	FOREIGN KEY  (tool_id) REFERENCES Tools (tool_id),
	ADD CONSTRAINT FK_Order_customer_username_Customer_username
...
ALTER TABLE Pliers
	ADD CONSTRAINT FK_Pliers_tool_id_Tools_tool_id
    FOREIGN KEY (tool_id) REFERENCES Tools (tool_id);
