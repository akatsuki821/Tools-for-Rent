...
CREATE TABLE `Customer` (
  ...
  `customer_id` int(16) UNSIGNED UNIQUE AUTO_INCREMENT,
...
('Flora', '345-134-5678', '12345678910', 'Xiaohua Cao', '2027-11-13', '788', 11, '7900 CAMBRIDGE STR, Houston, TX 77054'),
('Jane', '780-602-9596', '4716466093320331', 'Grace Barnes', '2021-05-00', '777', 6, '2867 Faucibus Av., Villa Agnedo, 46846-075'),
('Kaseem', '215-779-7485', '4916975583579642', 'August Bird', '2019-02-00', '348', 8, '196 Per Ave, Borghetto di Borbera, 66859-982'),
('Kasimir', '101-141-9092', '4485513780629471', 'Serena Combs', '2030-03-00', '810', 1, 'Ap #748-156 Mauris. Road, Sluizen, 976500'),
('Logan', '314-454-2777', '4556961742246823', 'Ralph Benton', '2021-01-00', '152', 4, 'Ap #498-9610 Mi Road, Bovigny, V3C 7S1'),
('Nathaniel', '444-154-4146', '4916121768385782', 'Fiona Ward', '2024-07-00', '673', 2, '733-2163 Donec Rd., Perk, ZY5B 9QT'),
('Owen', '449-594-2020', '4716217022968', 'Ignatius Powers', '2024-05-00', '399', 5, '272-5386 Morbi Road, Purral, 165'),
('Quynn', '667-880-9043', '4532891940432660', 'Genevieve Gregory', '2018-04-00', '629', 9, 'Ap #765-7007 Odio. Av., Blieskastel, 73-188'),
('Selma', '775-411-5413', '4929384332083383', 'Bree Rivas', '2031-07-00', '203', 3, '993-460 In Ave, Snellegem, 1151');
...
(1, 'Audrey', 6, '2017-12-03', '2017-12-19'),
(1, 'Audrey', 7, '2017-12-03', '2017-12-19'),
(1, 'Audrey', 8, '2017-12-03', '2017-12-19'),
(1, 'Audrey', 12, '2017-12-03', '2017-12-19'),
(2, 'Audrey', 13, '2017-11-14', '2017-12-19'),
(3, 'Audrey', 14, '2017-12-14', '2017-12-19'),
(4, 'Chava', 15, '2017-12-14', '2017-12-19'),
(5, 'Kaseem', 16, '2017-12-01', '2017-12-19'),
(6, 'Kaseem', 17, '2017-11-14', '2017-12-03'),
(7, 'Kaseem', 18, '2017-11-14', '2017-12-03'),
(8, 'Kaseem', 19, '2017-11-14', '2017-12-03'),
(9, 'Owen', 20, '2017-11-14', '2017-12-03'),
(10, 'Owen', 21, '2017-11-14', '2017-12-03'),
(11, 'Owen', 22, '2017-11-14', '2017-12-03');
...
(1, 'China', 'mental', '1', '3.25', '3.375', 2, 'manual'),
(2, 'China', 'plastic', '2', '1.25', '2.25', 3, 'manual'),
(3, 'USA', 'metal', '2', '2.375', '2.375', 2, 'manual'),
(4, 'China', 'metal', '2', '3.375', '2.25', 2, 'manual'),
(5, 'Japan', 'metal', '3', '6.5', '6.125', 3.9, 'manual'),
(6, 'China', 'metal', '2', '4.625', '5.375', 5, 'manual'),
(7, 'China', 'plastic', '2', '2.25', '3.25', 6.9, 'manual'),
(8, 'Taiwan', 'wooden', '2', '4.375', '2.5', 3.9, 'manual'),
(9, 'China', 'metal', '2', '2.25', '3.125', 3, 'manual'),
(10, 'USA', 'wooden', '1', '2.25', '3.125', 2.2, 'manual'),
(11, 'China', 'plastic', '2', '3.25', '2.125', 2, 'manual'),
(12, 'China', 'wooden', '2', '2.25', '3.125', 2, 'manual'),
(13, 'USA', 'metal', '1', '2.75', '3.125', 2, 'manual'),
(14, 'France', 'metal', '2', '2.25', '3.25', 44, 'manual'),
(15, 'China', 'metal', '23', '45.25', '22.25', 34, 'manual'),
(16, 'China', 'wooden', '23', '23.375', '33.25', 233, 'manual'),
(17, 'USA', 'metal', '2', '2.25', '3.25', 34, 'electric(A/C)'),
(18, 'China', 'plastic', '23', '2.375', '3.25', 34, 'cordless(D/C)'),
(19, 'China', 'metal', '2', '2.125', '3.25', 2, 'electric(A/C)'),
(20, 'USA', 'metal', '2', '2.25', '3.125', 2, 'cordless(D/C)'),
(21, 'USA', 'plastic', '2', '2.875', '3.25', 2, 'gas'),
(22, 'USA', 'metal', '23', '2.375', '3.25', 45, 'electric(A/C)'),
(23, 'China', 'metal', '2', '2.25', '4.25', 23, 'electric(A/C)'),
(24, 'China', 'plastic', '2', '2.5', '4.5', 2, 'gas'),
(25, 'China', 'metal', '4', '2.375', '4.5', 22, 'gas'),
(26, 'France', 'metal', '2', '2.25', '3.25', 3, 'electric(A/C)'),
(27, 'China', 'metal', '2', '2.25', '3.5', 2, 'cordless(D/C)');
...
ALTER TABLE `DropOff`
  ...
  ADD KEY `FK_DropOff_clerk_username_Clerk_username` (`clerk_username`);
...
--
ALTER TABLE `Rented`
  ADD PRIMARY KEY (`customer_username`,`rented_reservation_id`);
...
--
ALTER TABLE `Reservation`
  MODIFY `reservation_id` int(16) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
