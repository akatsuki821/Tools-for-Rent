...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($reservation_id_count == 0){
        ...
        array_push($error_msg,  "Reservation is not exist");     
         ...
         header(REFRESH_TIME . 'url=pick_up_reservation_credit_card.php');
    }
}
...
Left Outer Join PickUp AS P on R.reservation_id = P.reservation_id
    ...
    <div class="center_content">
        <div class="center_left">
            ...
            <div class="features">   
              ...
              <form action = "pick_up_reservation.php" method = "post" style = "width: 750px">
               <div class = "two_form">
